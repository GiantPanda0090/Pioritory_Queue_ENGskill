...
./run_list.sh $1 0 $2 > plot/1/linkedlist.dat
echo "1st run"	
./run_list.sh $1 0 $2 > plot/2/linkedlist.dat	
echo "2nd run"
...
echo "1st run"	
./run_list.sh $1 0 $2 > plot/5/linkedlist.dat
echo "2nd run"	
./run_list.sh $1 0 $2 > plot/6/linkedlist.dat
echo "3rd run"
echo "linkedlist done"	
echo "2nd data pattern done"
./run_list.sh $1 0 $2 > plot/7/linkedlist.dat
echo "1st run"	
./run_list.sh $1 0 $2 > plot/8/linkedlist.dat
echo "2nd run"	
