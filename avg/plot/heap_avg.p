...
data1 = "<( paste avg/plot/*/heap.dat avg/plot/heap_min.dat avg/plot/heap_max.dat)"
data2 = "<( paste avg/plot/*/linkedlist.dat avg/plot/list_min.dat avg/plot/list_max.dat)"
