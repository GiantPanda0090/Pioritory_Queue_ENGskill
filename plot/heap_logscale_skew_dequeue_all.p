...
set terminal png
set output "skew_dequeue_logscale.png"
...
set title "The Dequeue pefromence of using heap as pirority queue (logscale)"
...
data1 = "<( paste best/plot/dequeue/heap_prob.dat best/plot/dequeue/heap_mean.dat )"
data2 = "<( paste avg/plot/dequeue/heap_prob.dat avg/plot/dequeue/heap_mean.dat avg/plot/dequeue/heap_min.dat avg/plot/dequeue/heap_max.dat)"
data3 = "<( paste worst/plot/dequeue/heap_prob.dat worst/plot/dequeue/heap_mean.dat worst/plot/dequeue/heap_min.dat worst/plot/dequeue/heap_max.dat)"
