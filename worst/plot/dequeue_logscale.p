...
set title "The Worst dequeue pefromence of using skew heap vs linked list as pirority queue (logscale)"
...
plot data1 u 1:(column(2)) w lp pt 6 ps 2 title 'skew heap',data2 u 1:(column(2)) w lp pt 6 ps 2 title 'linked list', data1 u 1:(column(2)):((column(3)-column(2))) w yerr title 'skew heap error bar' ,data2 u 1:(column(2)):((column(3)-column(2))) w yerr title 'linked list error bars',f2(x) lc rgb "red" title "linefit for linkedlist",f1(x) lc rgb "red" title "linefit for skew heap"
