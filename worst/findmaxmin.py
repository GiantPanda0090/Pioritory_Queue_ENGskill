...
def minmax():
    command_list=[]
    command_list.append(('paste worst/plot/*/heap.dat > columns.txt','worst/plot/heap_min.dat','worst/plot/heap_max.dat'))
    command_list.append(('paste worst/plot/*/linkedlist.dat > columns.txt','worst/plot/list_min.dat','worst/plot/list_max.dat'))
