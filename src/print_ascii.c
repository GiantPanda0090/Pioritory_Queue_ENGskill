//reference:http://web.archive.org/web/20090617110918/http://www.openasthra.com/c-tidbits/printing-binary-Tree-in-ascii/
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
#include <time.h>
...
void sample() 
{
  ...
  printf("\nAfter inserting values 9, 13..\n");
  root = insert(9, root);
  root = insert(13, root);
  print_ascii_tree(root);

  printf("\nAfter inserting values 2, 6, 12, 14, ..\n");
  root = insert(2, root);
  root = insert(6, root);
  root = insert(12, root);
  root = insert(14, root);
